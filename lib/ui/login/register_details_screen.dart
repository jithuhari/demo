...
class RegisterDetailsScreen extends StatelessWidget {
  ...
  Widget _view() {
    return Column(
      children: [
        const SizedBoxH50(),
        WidgetUtils.linearProgressBar(80),
        Expanded(
          child: ListView(
            shrinkWrap: true,
            ...
            children: [
              ...
              const SizedBoxH30(),
              TextPOP18W700(
                AppStrings.registrationDetails,
              ...
              const SizedBoxH30(),
              TextPOP16W400(
                AppStrings.uploadRegistrationCertificate,
                textAlign: TextAlign.left,
                color: Colors.black.withOpacity(.3),maxLine: 1,style:  Theme.of(navigatorKey.currentContext!)
                  .textTheme
                  .bodyMedium
  ...
  Widget _regNumber() {
    return AppTextFormFieldUnderLine(
      ...
      hint: AppStrings.registrationNumber,
      // autoValidate: data == PageState.validationError,
      // validator: Validator.isValidMobileNumber,
      inputType: TextInputType.number, borderColor: Colors.black.withOpacity(.3),
    );
  }
  Widget _upoadCertificate(){
    ...
    return DottedBorder(
      ...
      strokeWidth: 1,  radius: Radius.circular(CardRadius),
      dashPattern: [2, 2],padding: EdgeInsets.zero,
      customPath: (size) {
        return Path()
          ..moveTo(CardRadius, 0)
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Image.asset(Drawables.add,height: 26,width: 26,fit: BoxFit.contain,),
            const SizedBoxW10(),
        ...
        children: [
          ...
          Expanded(
            ...
            child: WidgetUtils.linearGradiantButton(
              onTapped: () => Get.to(const GSTDetailsScreen()),
